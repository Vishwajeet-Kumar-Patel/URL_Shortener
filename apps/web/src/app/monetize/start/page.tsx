...
function MonetizeStartContent() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(15,23,42,0.95),_rgba(2,6,23,1)_60%)] text-slate-700">
      <div className="mx-auto flex min-h-screen max-w-3xl items-center px-4 py-10 sm:px-6 lg:px-8">
        <section className="w-full rounded-[2rem] border border-slate-200 bg-slate-50 p-6 shadow-2xl shadow-slate-950/40 backdrop-blur-xl sm:p-8">
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            ...
            <aside className="rounded-[1.5rem] border border-slate-200 bg-slate-50/60 p-5">
              <p className="text-xs font-semibold uppercase tracking-[0.24em] text-slate-500">Preparing your path</p>
              ...
              <div className="mt-6 rounded-2xl border border-dashed border-cyan-500/30 bg-cyan-500/5 p-4 text-sm leading-6 text-slate-600">
              ...
              <button
                ...
                disabled={!ready}
                className="mt-6 w-full rounded-2xl bg-white px-5 py-3 text-sm font-semibold text-slate-950 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:bg-slate-700 disabled:text-slate-600"
              >
